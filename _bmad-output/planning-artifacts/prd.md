...
> **Generated by**: BMAD Method v6.6.0 | Agent: PM (John) | Workflow: `bmad-create-prd`  
> **Date**: 2026-04-30 | **Status**: Approved | **Output path**: `_bmad-output/planning-artifacts/prd.md`
...
| NFR-03 | Portability | Runs on macOS, Linux, Windows (Node 22+) |
...
| Epic 01 | `_bmad-output/planning-artifacts/epic-01-habit-management.md` |
| Epic 02 | `_bmad-output/planning-artifacts/epic-02-daily-tracking.md` |
| Epic 03 | `_bmad-output/planning-artifacts/epic-03-statistics.md` |
| Epic 04 | `_bmad-output/planning-artifacts/epic-04-cli-ux.md` |
